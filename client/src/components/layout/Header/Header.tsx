...
import FeedUpload from "../ImgUpload/FeedUpload";
...
const MobileHeader = styled.div`
  ...
  @media screen and (max-width: 760px) {
    ...
    width: 100vw;
    background-color: ${(props) => props.theme.containerColor};
    border-bottom: 1px solid ${(props) => props.theme.containerLine};
    padding: 0 24px;
    top: 0;
    position: fixed;
    display: flex;
...
`;
export const Svg = styled.svg<{ clicked?: boolean }>`
    ...
    <>
      ...
      <Nav>
        ...
        <NavMenu>
          ...
          <SvgContainer onClick={() => setOnFeedUploadClicked(true)}>
            <NavMenuTip>만들기</NavMenuTip>

            <Svg
              clicked={onFeedUploadClicked}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
            >
